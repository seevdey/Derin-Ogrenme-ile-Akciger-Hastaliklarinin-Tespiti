...
ayikla("images", "Data_Entry_2017.csv", "Infiltration", 1000, 300, 300)
ayikla("images", "Data_Entry_2017.csv", "No Finding", 1000, 300, 300)
ayikla("images", "Data_Entry_2017.csv", "Atelectasis", 1000, 300, 300)